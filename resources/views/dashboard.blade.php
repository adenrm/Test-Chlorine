    ...
    <div class="bg-gray-100 font-sans">
        <div class="flex h-screen">
            ...
            <aside class="w-64 bg-white p-4 flex shadow-md flex-col">
                ...
                <a href="{{ route('category') }}" class="flex items-center py-2 px-3 rounded-md text-gray-700 hover:bg-gray-200 {{ request()->routeIs('category.index') ? 'bg-gray-200' : '' }}">
                ...
                <a href="#" class="flex items-center py-2 px-3 rounded-md text-gray-700 hover:bg-gray-200">
                 ...
                 <a href="{{ route('auth.index') }}" class="flex items-center py-2 px-3 rounded-md text-gray-700 hover:bg-gray-200 {{ request()->routeIs('auth.index') ? 'bg-gray-200' : '' }}">
        ...
        <main class="flex-1 p-6">
            <h1 class="text-2xl font-semibold text-gray-800 mb-6">Dashboard</h1>
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
               <a href="{{ route('auth.index') }}" class="bg-white rounded-lg shadow-md p-6 flex items-center justify-center flex-col text-center hover:bg-gray-200 transition-colors duration-200">
                <div class="bg-purple-100 p-3 rounded-full mb-3">
                    <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h10a2 2 0 002-2V9m-4 0a2 2 0 100-4 2 2 0 000 4zm0 0v-3m2 3h-2M15 11l-3-3m0 0l-3 3"></path>
                    </svg>
                </div>
                <p class="text-lg font-medium text-gray-700">Lengkapi Profile</p>
            </a>
                
                <div class="bg-white rounded-lg shadow-md p-6 flex items-center justify-center flex-col text-center">
                    <div class="bg-pink-100 p-3 rounded-full mb-3">
                        <svg class="w-8 h-8 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-1.002-8.705-2.745M10 17v-4a2 2 0 114 0v4m-3 0h6m-1 0v-4a2 2 0 10-4 0v4m0 0H7a2 2 0 00-2 2v2a2 2 0 002 2h10a2 2 0 002-2v-2a2 2 0 00-2-2h-3"></path></svg>
                    </div>
                    <p class="text-lg font-medium text-gray-700">Lowongan Kerja</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 flex items-center justify-center flex-col text-center">
                    ...
                    <p class="text-lg font-medium text-gray-700">Permohonan Saya</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 flex items-center justify-center flex-col text-center">
                    ...
                    <p class="text-lg font-medium text-gray-700">Survey Kepuasan</p>
                </div>
            </div>

            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Lorem, ipsum.</h2>
                <div class="overflow-x-auto">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio sunt ad impedit quia fuga doloremque harum repellat quidem ea! Magnam cupiditate repellat quasi, amet ipsum quo nemo maiores. Sapiente provident assumenda laboriosam a sit. Eius reprehenderit ipsa dolorum placeat doloribus numquam harum cumque quas quae, distinctio laborum pariatur minus nemo debitis accusantium incidunt neque optio, esse at a temporibus! Vel perspiciatis porro quae. Tempora quas quod dolorem quisquam laboriosam, laudantium veniam alias. Ut voluptate aut esse tempore, a non mollitia adipisci magni similique, libero reprehenderit. Voluptate beatae, voluptates cupiditate corporis asperiores ducimus explicabo quisquam ipsa quaerat delectus, accusantium, exercitationem est!
                </div>
            </div>
        </main>
    </div>
